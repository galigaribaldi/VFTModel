...
@phase: 3
@route: src/core/algorithms/topological/scc_analysis/orchestator.py
@date: 2026-07-04
"""

import networkx as nx
from src.core.utils.logger import vft_logger
from src.core.algorithms.topological.scc_analysis.engine import (
    compute_sorted_components,
    extract_giant_component,
    compute_giant_metrics
)
from src.core.algorithms.topological.scc_analysis.diagnostics import (
